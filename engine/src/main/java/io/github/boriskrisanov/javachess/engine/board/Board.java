...
import static io.github.boriskrisanov.javachess.engine.board.Direction.*;
...
public class Board {
    ...
    public void makeMove(String uciMove) {
        ...
        if (board[start] instanceof King) {
            if (board[start].getColor() == Piece.Color.BLACK && destination == 6 && castlingRights.blackCanShortCastle) {
                castlingDirection = CastlingDirection.SHORT;
            } else if (board[start].getColor() == Piece.Color.BLACK && destination == 1 && castlingRights.blackCanLongCastle) {
                castlingDirection = CastlingDirection.LONG;
            } else if (board[start].getColor() == Piece.Color.WHITE && destination == 62 && castlingRights.whiteCanShortCastle) {
                castlingDirection = CastlingDirection.SHORT;
            } else if (board[start].getColor() == Piece.Color.WHITE && destination == 58 && castlingRights.whiteCanLongCastle) {
                castlingDirection = CastlingDirection.LONG;
            }
        }
    ...
    public void makeMove(Move move) {
        ...
        if (!isPromotion) {
            ...
            if (move.capturedPiece() != null) {
                if (move.capturedPiece().getColor() == Piece.Color.WHITE) {
...
//                board[move.destination()].setPosition(move.destination());
    ...
    public boolean isSideInCheck(Piece.Color side) {
        long kingBitboard = side == Piece.Color.WHITE ? whiteKing : blackKing;
    ...
    public String getPgn() {
        ...
        */
        ...
        while (it.hasNext()) {
            ...
            if (board2.isCheckmate(Piece.Color.WHITE) || board2.isCheckmate(Piece.Color.BLACK)) {
                moveString.append("#");
...
// ********************************************************
    ...
    public long getAllPieces() {
        return getPieces(Piece.Color.WHITE) | getPieces(Piece.Color.BLACK);
    }
